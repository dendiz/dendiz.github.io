...
## Summary Keywords
- *Software Engineering* (Developer Tooling, CI/CD, App Intents)
- *Quantitative Finance* (Algorithmic Trading, Financial Modeling)
- *Self-Hosting & Homelab* (Infrastructure Automation, Media Servers)
- *Game Development* (Strategy Simulations, Liquidate)
- *Personal Productivity* (Knowledge Management, Obsidian)
- *Interests* (Warhammer 40k, Metalcore Music)
