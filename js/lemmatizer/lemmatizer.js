...
var Lemmatizer = function() {
  this.wn_files = {
    noun: [
      '/js/dict/index.noun.json',
      '/js/dict/noun.exc.json'
    ],
    verb: [
      '/js/dict/index.verb.json',
      '/js/dict/verb.exc.json'
    ],
    adj:  [
      '/js/dict/index.adj.json',
      '/js/dict/adj.exc.json'
    ],
    adv:  [
      '/js/dict/index.adv.json',
      '/js/dict/adv.exc.json'
    ]
  };
